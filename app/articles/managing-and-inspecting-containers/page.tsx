...
export default function BlogPage() {
  ...
  return (
    <div className="container mx-auto px-6 sm:px-10 md:px-16 lg:px-24 py-24 max-w-6xl">
      {/* Blog Header at top */}
      <BlogHeader title="Managing & Inspecting Containers" date="Oct 15, 2025" />
      ...
      <div className="mt-16 flex flex-col lg:flex-row gap-12">
        ...
        <main className="flex-1">
          <BlogContent hero="https://d21r3yo3pas5u.cloudfront.net/thumbnail/inspect-containers.png">
            <p>
              Welcome to the Docker Series — in this post, we’ll cover the
              basics of containerization, why Docker matters, and how to get
              started.
            </p>
            ...
            <p>
              ...
              applications and dependencies into containers. Containers ensure
              your app runs the same regardless of where it’s deployed — your
              laptop, staging server, or the cloud.
            </p>

            <h2>Why Use Docker?</h2>
            <p>
              Docker simplifies development, testing, and deployment by
              providing lightweight, isolated environments. Instead of worrying
              about “it works on my machine,” Docker guarantees consistency.
            </p>

            <h2>Docker Hub</h2>
            <p>
              Docker Hub is a public registry that hosts container images. It’s
              like GitHub for Docker — where you can push, share, and pull
